...
namespace gradingform_matrix\grades\grader\gradingpanel\external;
...
final class fetch_test extends advanced_testcase {
    ...
    public function test_execute_fetch_empty(): void {
        ...
        $this->assertEquals('gradingform_matrix/grades/grader/gradingpanel', $result['templatename']);
        ...
        $this->assertCount(count($definition->matrix_criteria), $criteria);
        foreach ($criteria as $criterion) {
            $this->assertArrayHasKey('id', $criterion);
            $criterionid = $criterion['id'];
            $sourcecriterion = $definition->matrix_criteria[$criterionid];
