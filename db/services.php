...
$functions = [
    'gradingform_matrix_grader_gradingpanel_fetch' => [
        'classname' => 'gradingform_matrix\\grades\\grader\\gradingpanel\\external\\fetch',
        'description' => 'Fetch the data required to display the grader grading panel, ' .
            'creating the grade item if required',
        'type' => 'write',
        'ajax' => true,
    ],
    'gradingform_matrix_grader_gradingpanel_store' => [
        'classname' => 'gradingform_matrix\\grades\\grader\\gradingpanel\\external\\store',
