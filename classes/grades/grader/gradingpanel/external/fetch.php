...
require_once($CFG->dirroot.'/grade/grading/form/matrix/lib.php');
...
class fetch extends external_api {
    ...
    public static function get_fetch_data(gradeitem $gradeitem, stdClass $gradeduser): array {
        ...
        $fillings = $instance->get_matrix_filling();
        ...
        if ($definition->matrix_criteria) {
            ...
            $criterion = array_map(function($criterion) use ($definitionid, $fillings, $context, $hasgrade) {
                ...
                $nulllevel = [
                    ...
                    'criterionid' => $criterion['id'],
                    'score' => '-',
                    'definition' => get_string('notset', 'gradingform_matrix'),
                    'checked' => !$hasgrade,
                ];
                // Consult the grade filling to see if a level has been selected and if it is the current level.
                ...
                return $result;
            }, $definition->matrix_criteria);
        }

        return [
            'templatename' => 'gradingform_matrix/grades/grader/gradingpanel',
            'hasgrade' => $hasgrade,
            'grade' => [
